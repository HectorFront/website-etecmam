...
module.exports = {
    ...
    <body>
        <div
            style="background-color:#ececec;padding:0;margin:0 auto;font-weight:200;width:100%!important; height:100%!important">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left" valign="middle" width="50%"><span
                                                                    style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">Data:</span>
                                                            </td>
                                                            <td valign="middle" width="50%" align="right"
                                                                style="padding:0 0 0 10px"><span
                                                                    style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">${moment(new
            Date()).format("DD/MM/YYYY HH:mm")}</span></td>
                                                            <td width="1">&nbsp;</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center" width="100%"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:20px;letter-spacing:3px;text-decoration:none;font-weight:bold"
                                                                                                        class="button-color">${codeRecuperation}</span>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" valign="middle" width="100%"
                                                                                ...
                                                                                <b>Não consegue acessar?</b> Use o link: <a
                                                                                    href="http://www.etecmam.com.br/login">www.etecmam.com.br/login</a>,
                                                                                <br><b>Precisa de ajuda?</b> Envie um email
                                                                                para: hectddos103@gmail.com </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
