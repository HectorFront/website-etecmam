...
var updateProf = function updateProf(id) {
    event.preventDefault();
    var PermissionToken = localStorage.getItem(btoa('login'));
    var idURL = void 0,
        PermissionidUser = localStorage.getItem(btoa('idUser'));
    ...
    if (PermissionidUser === PermissionidDefault) {
        ...
        $.get(ENV.API_URL + '/get/user/' + PermissionidUser).done(function (res) {
            ...
            if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                var nomeProf = $('#name' + id).val();
                var emailProf = $('#email' + id).val();
                    ...
                    swal({
                        ...
                        if (willUpdate) {
                            ...
                            $.ajax({
                                ...
                                swal("Professor atualizado!", "Clique em ok para sair", "success").then(function () {
                                    var loading = '\n                                            <div class="load">\n                                                <div class="lds-ring">\n                                                    <div></div>\n                                                    <div></div>\n                                                    <div></div>\n                                                    <div></div>\n                                                </div>\n                                            </div>';
                                ...
                                swal("Professor não atualizado, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(function () {
