...
var deleteModalFunc = function deleteModalFunc(id) {
                ...
                swal({
                    ...
                    if (results) {
                        ...
                        $.ajax({
                            ...
                            swal("Funcionário deletado!", "Clique em ok para sair", "success").then(function () {
                            ...
                            swal("Funcionário não deletado, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(function () {
