...
var deleteUser = function deleteUser(idUser) {
                ...
                swal({
                    ...
                    if (results) {
                        $.ajax({
                            ...
                            swal("Usuário deletado com sucesso!", "Clique em ok para sair", "success").then(function () {
                            ...
                            swal("Erro ao deletar usuário, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(function () {
                                window.location.reload();
                            });
                        });
                    }
