...
var deletePublication = function deletePublication(id) {
                ...
                swal({
                    ...
                    if (results) {
                        ...
                        $.ajax({
                            ...
                            swal("Publicação deletada!", "Clique em ok para sair", "success").then(function () {
                                window.location.reload();
                            });
                        }).fail(function () {
                            swal("Publicação não deletada, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(function () {
                                window.location.reload();
                            });
                        });
                    } else {
