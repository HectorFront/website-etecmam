...
$('#info-escola').on('submit', function (event) {
  ...
  if (PermissionidUser === PermissionidDefault) {
    ...
    $.get(ENV.API_URL + '/get/user/' + PermissionidUser).done(function (res) {
      ...
      if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
        ...
        var tradicao = $('#tradicao').val();
        var quantidadecursos = $('#quantidadecursos').val();
        ...
        swal({
          ...
          if (results) {
            ...
            $.ajax({
              ...
              swal("Informações editadas!", "Clique em ok para sair", "success").then(function () {
              ...
              swal("Falha na edição, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(function () {
