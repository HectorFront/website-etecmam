            ...
            .done(res => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    swal({
                        ...
                        text: "Se fizer isso o usuário não conseguirá mais ter acesso!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                        ...
                        if (results) {
                            $.ajax({
                                url: `${ENV.API_URL}/delete/user/${idUser}`,
                                method: 'DELETE',
                                headers: {
                                ...
                                $.get(`${ENV.API_URL}/get/user/${idURL}`)
                                    .done(res => {
                                        ...
                                        let data = {
                                            ...
                                            cargo: res.cargo,
                                            atividade: 'Deletou um usuário na plataforma'
                                        }
                                ...
                                swal("Usuário deletado com sucesso!", "Clique em ok para sair", "success").then(() => {
                                ...
                                swal("Erro ao deletar usuário, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(() => {
                                    window.location.reload();
                                });
                            })
                        }
