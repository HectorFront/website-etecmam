const updateUser = () => {
    ...
    let idUser = localStorage.getItem(btoa('idUser'));
    ...
    <strong>Senha fraca!</strong> A senha tem que ter pelo menos 6 letras minúsculas com um 1 número!
</div>`;
        ...
        $.get(`${ENV.API_URL}/get/user/${PermissionidUser}`)
            .done((res, status, xhr) => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    ...
                    let email = $('#email').val();
                    let senha = $('#senha').val();
                    let confirmsenha = $('#confirmar_senha').val();
                    let cargo = $('#cargo').val();
                        ...
                        swal({
                            ...
                            if (results) {
                                ...
                                $.ajax({
                                    ...
                                    $('.alert').remove();
                                    swal("Usuário salvo com sucesso!", "Clique em ok para sair", "success")
                                        .then(() => {
                                    ...
                                    swal("Erro ao salvar usuário, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(() => {
