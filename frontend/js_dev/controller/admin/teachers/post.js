      ...
      .done(res => {
        ...
        if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
          ...
          if (!nome || !email) {
            ...
            $.ajax({
              url: `${ENV.API_URL}/post/professores`,
              ...
              $.get(`${ENV.API_URL}/get/user/${(idURL)}`)
                .done(res => {
                  ...
                  let data = {
                    ...
                    cargo: res.cargo,
                    atividade: 'Cadastrou um <a href="/Professores-ADMIN">professor</a>'
                  }
              ...
              swal("Professor cadastrado!", "Clique em ok para sair", "success").then(() => {
              ...
              swal("Erro ao cadastrar, por favor contatar com os programadores!", "Clique em ok para sair", "error")
                .then(() => {
