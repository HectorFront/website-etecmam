            ...
            .done(res => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    swal({
                        ...
                        text: "Se você deletar este professor a lista será atualizada automaticamente!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
                        .then((results) => {
                            if (results) {
                                ...
                                $.ajax({
                                    url: `${ENV.API_URL}/delete/professor/${id}`,
                                    method: 'DELETE',
                                    headers: {
                                    ...
                                    $.get(`${ENV.API_URL}/get/user/${(idURL)}`)
                                        .done(res => {
                                            ...
                                            let data = {
                                                ...
                                                cargo: res.cargo,
                                                atividade: 'Deletou em <a href="/Professores-ADMIN">Professores</a>'
                                            }
                                    ...
                                    swal("Professor deletado!", "Clique em ok para sair", "success").then(() => {
                                        let loading = `
                                            <div class="load">
                                                <div class="lds-ring">
                                                    <div></div>
                                    ...
                                    swal("Professor não deletado, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(() => {
                                        window.location.reload();
                                    });
                                });

                            } else {
                                swal("Deleção cancelada!", "Clique em ok para sair", "error");
                            }
                        });
                } else {
                    platformLogout();
