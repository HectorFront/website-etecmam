            ...
            .done(res => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    swal({
                        ...
                        text: "Se você deletar este funcionário a lista será atualizada automaticamente!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
                        .then((results) => {
                            if (results) {
                                ...
                                $.ajax({
                                    url: `${ENV.API_URL}/delete/funcionario/${id}`,
                                    method: 'DELETE',
                                    headers: {
                                    ...
                                    $.get(`${ENV.API_URL}/get/user/${(idURL)}`)
                                        .done(res => {
                                            ...
                                            let data = {
                                                ...
                                                cargo: res.cargo,
                                                atividade: 'Deletou em <a href="/Funcionarios-Admin">Funcionários</a>'
                                            }
                                    ...
                                    swal("Funcionário deletado!", "Clique em ok para sair", "success").then(() => {
                                    ...
                                    swal("Funcionário não deletado, por favor contatar com os programadores!", "Clique em ok para sair", "error").then(() => {
