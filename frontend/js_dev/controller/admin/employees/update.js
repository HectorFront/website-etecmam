        ...
        $.get(`${ENV.API_URL}/get/user/${PermissionidUser}`)
            .done(res => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    let nome = $(`#name${id}`).val();
                    let cargo = $(`#office${id}`).val();
                            ...
                            .then((willUpdate) => {
                                if (willUpdate) {
                                    ...
                                    $.ajax({
                                        ...
                                        swal("Funcionário atualizado!", "Clique em ok para sair", "success").then(() => {
                                        ...
                                        swal("Funcionário não atualizado, por favor contatar os programadores!", "Clique em ok para sair", "error").then(() => {
