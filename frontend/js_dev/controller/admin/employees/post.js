$('#employees-form').on('submit', (event) => {
            ...
            .done(res => {
                ...
                if (PermissionToken === res.webtoken && hashValidade === generateHash(res.email)) {
                    ...
                    if (!nome || !cargo) {
                        ...
                        $.ajax({
                            url: `${ENV.API_URL}/post/funcionarios`,
                            ...
                            $.get(`${ENV.API_URL}/get/user/${(idURL)}`)
                                .done(res => {
                                    ...
                                    let data = {
                                        ...
                                        cargo: res.cargo,
                                        atividade: 'Cadastrou um <a href="/Funcionarios-Admin">Funcionário</a>'
                                    }
                            ...
                            swal("Funcionário cadastrado!", "Clique em ok para sair", "success").then(() => {
